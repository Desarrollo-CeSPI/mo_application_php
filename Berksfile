...
cookbook 'mo_backup',           git: 'https://github.com/Desarrollo-CeSPI/mo_backup.git', tag: 'v0.1.40'
...
cookbook 'mo_application',      git: 'https://github.com/Desarrollo-CeSPI/mo_application.git', tag: 'v1.1.17'
